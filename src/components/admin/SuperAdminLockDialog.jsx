...
const SuperAdminLockDialog = ({ isOpen, onClose, onSubmit, isChecking }) => {
      ...
      <DialogContent className="bg-slate-900 border-gray-700 text-white">
        <DialogHeader>
          <DialogTitle className="flex items-center text-red-400">
            ...
            Autorización de Súper Administrador Requerida
          </DialogTitle>
          <DialogDescription>
            Esta es una acción crítica que requiere la contraseña de Súper Administrador.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <Input
              ...
              placeholder="Contraseña de Súper Administrador"
...
export default SuperAdminLockDialog;