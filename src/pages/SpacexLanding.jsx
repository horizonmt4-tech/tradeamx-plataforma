...
// ============= CONFIG =============
const WHATSAPP_NUMERO = '5215574435022';
...
export default function SpacexLanding() {
  ...
  return (
    <>
      <Helmet>
        <title>Opera el IPO de SpaceX desde el día 1 | TradeAMX</title>
        ...
        <meta property="og:title" content="Opera el IPO de SpaceX | TradeAMX" />
      ...
      <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: '#0A1628', color: 'white', minHeight: '100vh' }}>
        ...
        <section style={styles.seccion}>
          <div style={styles.container}>
            ...
            <div style={styles.grid3}>
              <CardProblema icon={XCircle} titulo="Asignaciones mínimas en brokers retail" descripcion="Los brokers tradicionales asignan entre 0.1% y 2% del IPO a clientes minoristas. Y solo si tienes una relación previa." />
              <CardProblema icon={XCircle} titulo="Mercado pre-IPO restringido" descripcion="Plataformas como Forge o EquityZen exigen ser inversionista acreditado: mínimo $200K USD en activos para participar." />
              <CardProblema icon={XCircle} titulo="Precio inflado en el listado" descripcion="Cuando finalmente puedas comprar en mercado abierto, el precio puede haber subido 30-50% por el FOMO del primer día." />
            </div>
          </div>
        </section>
        ...
        <section style={{ ...styles.seccion, background: '#0F1F38' }}>
          <div style={styles.container}>
            ...
            <div style={styles.grid3}>
              <CardPaso numero="01" titulo="Pasas la evaluación" descripcion="Costo único de $35 USD. La evaluación toma 2-7 días según tu ritmo. Reglas claras, sin trucos." />
              <CardPaso numero="02" titulo="Recibes tu cuenta" descripcion="Te otorgamos acceso a una cuenta institucional de $25K, $50K o $100K USD en 24-48 hrs." destacado />
              <CardPaso numero="03" titulo="Operas SPCX el 12 de junio" descripcion="Desde el primer minuto del listado, con apalancamiento, sin arriesgar tu capital propio. Recibes el 80% del rendimiento." />
            </div>
        ...
        <section style={styles.seccion}>
          <div style={styles.container}>
            ...
            <h2 style={styles.h2}>¿En qué grupo quieres estar el 12 de junio?</h2>
            <div style={styles.comparativa}>
              <ColumnaComparativa
                titulo="Broker retail" subtitulo="La mayoría del público" negativa
                items={['Asignación 0.1% - 2% del IPO', 'Inviertes tu propio dinero', 'Pierdes capital si la acción baja', 'Cobran comisiones por trade', 'Sin apalancamiento']}
                destacado="Capital activo típico: $500-$5,000 USD"
              />
              <ColumnaComparativa
                titulo="Cuenta institucional" subtitulo="Con nosotros" positiva
                items={['Acceso al CFD desde minuto 1', 'Capital de la firma, no tuyo', 'No arriesgas tu dinero propio', 'Sin comisiones por operación', 'Apalancamiento institucional']}
        ...
        <section style={{ ...styles.seccion, background: '#0F1F38' }}>
          <div style={styles.container}>
            ...
            <div style={styles.testimonios}>
              <Testimonio nombre="Carlos M." ubicacion="México" texto="Pasé la evaluación en 5 días y recibí mi cuenta de $50K. El equipo de soporte me explicó todo el proceso por WhatsApp." />
              <Testimonio nombre="Ana R." ubicacion="Colombia" texto="Llevaba 2 años intentando operar con mi propio capital. Con la cuenta institucional cambió todo." />
              <Testimonio nombre="Diego F." ubicacion="Argentina" texto="Ya estoy preparando mi estrategia para el día del listado. La plataforma soporta CFDs sobre acciones de NASDAQ." />
            </div>
          </div>
        </section>
        ...
        <section style={styles.seccion}>
          <div style={{ ...styles.container, maxWidth: 720 }}>
            ...
            <FAQ pregunta="¿Realmente podré operar SPCX desde el día 1?" respuesta="Sí, nuestra plataforma agregará CFD sobre SPCX el mismo día del listado en NASDAQ. La disponibilidad oficial está sujeta a confirmación del listado." />
            <FAQ pregunta="¿Cuánto cuesta participar?" respuesta="La evaluación tiene un costo único de $35 USD. No hay mensualidades, no hay sorpresas. Si pasas la evaluación, recibes la cuenta institucional sin costos adicionales." />
            <FAQ pregunta="¿Y si no paso la evaluación?" respuesta="Puedes intentar de nuevo pagando otra evaluación. No hay penalización ni reportes en buró. Es un proceso de habilidad." />
            <FAQ pregunta="¿Cuánto tarda la aprobación de mi cuenta?" respuesta="Entre 24 y 48 horas después de pasar la evaluación. Para el 12 de junio, recomendamos empezar la evaluación a más tardar el 9 de junio." />
            <FAQ pregunta="¿Recibo dinero en mi cuenta bancaria?" respuesta="Sí, los payouts se procesan vía USDT (TRC20/ERC20), transferencia internacional o PayPal según tu preferencia. El 80% del rendimiento neto es tuyo." />
            <FAQ pregunta="¿Es legal en mi país?" respuesta="El programa de evaluación de trading es legal en la mayoría de países de LATAM. No es una inversión ni un instrumento financiero regulado. Consulta a un asesor local si tienes dudas específicas." />
          </div>
        </section>
        ...
        <footer style={styles.footer}>
          <div style={styles.container}>
            <p style={styles.disclaimer}>
              ...
              TradeAMX no proporciona asesoría financiera personalizada.
            </p>
            <p style={styles.copyright}>© {new Date().getFullYear()} TradeAMX. Todos los derechos reservados.</p>
          </div>
        </footer>
...
const styles = {
  ...
  heroBadge: { display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 14px', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: 999, fontSize: 12, fontWeight: 600, letterSpacing: '0.05em', marginBottom: 24, color: '#60A5FA' },
  ...
  ctaPrimario: { display: 'inline-flex', alignItems: 'center', gap: 10, padding: '14px 28px', background: '#25D366', color: 'white', border: 'none', borderRadius: 8, fontSize: 16, fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 16px rgba(37, 211, 102, 0.3)' },
  ctaSecundario: { display: 'inline-flex', alignItems: 'center', gap: 8, padding: '12px 24px', background: 'transparent', color: '#3B82F6', border: '1px solid #3B82F6', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  heroFooter: { marginTop: 16, fontSize: 13, color: '#64748B' },
  glowDecoration: { position: 'absolute', top: '-200px', left: '50%', transform: 'translateX(-50%)', width: 600, height: 600, background: 'radial-gradient(circle, rgba(59, 130, 246, 0.15) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 1 },
  ...
  comparativa: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 },
  columnaComp: { padding: 28, borderRadius: 12 },
  gridStats: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 24, marginBottom: 48 },
  testimonios: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 },
  ctaFinal: { padding: '80px 24px', background: 'linear-gradient(135deg, #1E40AF 0%, #1E3A8A 100%)', textAlign: 'center' },
  footer: { padding: '40px 24px', background: '#050B16', borderTop: '1px solid #1E293B' },
  disclaimer: { fontSize: 12, lineHeight: 1.6, color: '#64748B', maxWidth: 900, margin: '0 auto 16px', textAlign: 'center' },
  copyright: { fontSize: 12, color: '#475569', textAlign: 'center' },
  fabWhatsapp: { position: 'fixed', bottom: 24, right: 24, width: 60, height: 60, borderRadius: '50%', background: '#25D366', color: 'white', border: 'none', cursor: 'pointer', boxShadow: '0 4px 16px rgba(37, 211, 102, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 },
};