	...
	plugins: [
		...
		VitePWA({
			...
			manifest: {
				...
				short_name: 'TradeAMX',
				description: 'Únete a TradeAMX, la prop firm líder en trading. Obtén capital de hasta $100k para operar en los mercados financieros.',
				theme_color: '#0f172a',
			...
			devOptions: {
				enabled: false, // evita conflictos con el visual editor en dev
			},
		}),
	],
	server: {
